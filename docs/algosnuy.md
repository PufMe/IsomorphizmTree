...
Следует обратить внимание на одно предостережение. Перед сериализацией необходимо убедиться, что у наших деревьях выбран один и тот же корневой узел. Иначе мы получим две разные кодировки. Это легко избежать путем поиска центра церева.
...
Наш способ нахождения центра будет заключаться в многократном удалении внешнего слоя листовых узлов. Этот процесс напоминает очистку слоев лука (начинаешь с наружи, пока не дойдешь до серцевины).

1. Вычисляем степень каждого узла. Это количество узлов, с которыми он связан.
![рис.2](/Image/%D1%81%D1%82%D0%B5%D0%BF%D0%B5%D0%BD%D1%8C.jpg)
Из рисунка мы наблюдаем, что конечные узлы соеденены лишь с одним другим узлом.
2. Как только мы узнаем, какие узлы листовые, мы можем обрезать их и обновить степень узлов.
![рис.3](/Image/%D1%81%D1%82%D0%B5%D0%BF%D0%B5%D0%BD%D1%8C2.jpg)
...
![рис.4](/Image/%D1%81%D1%82%D0%B5%D0%BF%D0%B5%D0%BD%D1%8C3.jpg) 
...
![рис.5](/Image/%D0%BA%D0%BE%D0%B4%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B51.jpg)
...
![рис.5](/Image/%D0%BA%D0%BE%D0%B4%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B52.jpg)
3. Важно, что на этапе объединения дочерние ярлыки должны быть отсортированы
![](/Image/%D0%BA%D0%BE%D0%B4%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5%203.jpg)
    ...
    while (count < vertex_count) {
        ...
        for (int node : leaves) {
            for (int neighbour : graph[node]) {
                ...
                if (degree[neighbour] == 1) new_leaves.push(neighbour);
            }
            degree[node] = 0;
        }
...
### Построение дерева с корнем в центре
